	...
	<?php echo form_open(); ?>
		<table class="table">
			<tr>
				<td>Pubdate</td>
				<td>
					<div class="input-append date" id="dp1" data-date="<?php echo $article->pubdate ?>" data-date-format="yyyy-mm-dd">
					<?php echo form_input('pubdate', set_value('pubdate', $article->pubdate), 'class="datepicker span2" readonly'); ?>
